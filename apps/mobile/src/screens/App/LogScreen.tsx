  ...
  return (
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <Text style={styles.heading}>{entryId ? 'Edit Entry' : 'Log Weight'}</Text>
        ...
        <Controller
          ...
          render={({ field: { onChange, value } }) => (
            <TextInput
              style={[styles.input, errors.logged_at && styles.inputError]}
        ...
        />
        {errors.logged_at && <Text style={styles.fieldError}>{errors.logged_at.message}</Text>}
        ...
        />
        {errors.weight_kg && <Text style={styles.fieldError}>{errors.weight_kg.message}</Text>}
        ...
        >
          {isSubmitting
            ...
            : <Text style={styles.btnText}>{entryId ? 'Update entry' : 'Log weight'}</Text>}
        </TouchableOpacity>
      </ScrollView>
